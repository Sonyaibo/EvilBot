...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [🙂](https://telegra.ph/file/3e4011d78205c9031806a.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *Sonyaibo Robot*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *🖥️𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜🖥️*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="+Add Me To Your Group+", url="t.me/Sonyaibo_Robot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="About🌺", callback_data="evil_"),
        InlineKeyboardButton(
            text="My Update Channel", url=f"https://t.me/Soniaibo_Robot_Update_Channel"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/Sonyaibo_Robot_Support_Group"),
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 😊 *Sonyaibo Robot* [😊](https://telegra.ph/file/3e4011d78205c9031806a.jpg)
`𝙲𝚕𝚒𝚌𝚔 𝚘𝚗 𝚝𝚑𝚎 𝚋𝚞𝚝𝚝𝚘𝚗𝚜 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚐𝚎𝚝 𝚍𝚘𝚌𝚞𝚖𝚎𝚗𝚝𝚊𝚝𝚒𝚘𝚗 𝚊𝚋𝚘𝚞𝚝 𝚜𝚙𝚎𝚌𝚒𝚏𝚒𝚌 𝚖𝚘𝚍𝚞𝚕𝚎𝚜..`"""
Sonyaibo_IMG = "https://telegra.ph/file/3e4011d78205c9031806a.jpg"
SUPPORT_US = """Heya, glad to hear you want to support!
 You can support the project via [add tha bot to your group](#) \
 Supporting is always financial! \
